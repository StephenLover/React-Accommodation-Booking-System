...
dataUserInfo = pd.read_csv(dataPath + filename)
...
dataAccomInfo = pd.read_csv(dataPath +filename)
...
'''
dataAccomInfo_dict = dataAccomInfo.to_dict()
print (dataAccomInfo_dict['postcode'])
collectionAccommodations.insert(dataAccomInfo_dict)


data_json = json.loads(dataAccomInfo.to_json(orient='records'))
collectionAccommodations.remove()
collectionAccommodations.insert(data_json)
'''
