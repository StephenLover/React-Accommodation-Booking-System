...
collectionAccommodations = db['accommodations']
...
print (pd.DataFrame(list(accommodationsData)))
## calculate and insert the distance into dataframe given lng and lat
accommodationsData['dis'] = dis_2_point_dataframe(accommodationsData['lng'], accommodationsData['lat'], 15, 15, unit="m")
